...
export enum TokenFailureInfo {
  ...
  BUY_YES_INVALID_MARKET,
  BUY_YES_INVALID_MARKET_IMPL,
  BUY_YES_CASH_NOT_AVAILABLE,
  BUY_YES_VALIDATION,
  BUY_YES_INVALID_VAULT,
  BUY_YES_INVALID_YES_TOKEN,
  SET_PLATFORM_RESERVE_EXECUTION_POINT_ACCRUE_INTEREST_FAILED,
  SET_PLATFORM_RESERVE_EXECUTION_POINT_FRESH_CHECK,
  SET_POOL_RESERVE_EXECUTION_POINT_ACCRUE_INTEREST_FAILED,
  SET_POOL_RESERVE_EXECUTION_POINT_FRESH_CHECK,
